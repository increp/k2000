...
//==============================================================================
/// Auto-generated C++ class for the 'SvfLinear' processor
///
...
struct SvfLinear
{
    ...
    static constexpr std::string_view name = "SvfLinear";
    ...
    struct SvfLinear_State
    {
        int32_t _currentFrame = {};
        _SvfLinear_State _state;
    };
    ...
    SvfLinear_State cmajState = {};
    SvfLinear_IO cmajIO = {};

    //==============================================================================
    void _sendEvent_cutoffHz (SvfLinear_State& _state, float value) noexcept
    {
        _SvfLinear__cutoffHz (_state._state, value);
    }

    void _SvfLinear__cutoffHz (_SvfLinear_State& _state, float v) noexcept
    {
        _state.cutoff = v;
        _state.dirty = true;
    }

    void _sendEvent_resonance (SvfLinear_State& _state, float value) noexcept
    {
        _SvfLinear__resonance (_state._state, value);
    }

    void _SvfLinear__resonance (_SvfLinear_State& _state, float v) noexcept
    {
        _state.res = v;
        _state.dirty = true;
    }

    void _sendEvent_tap (SvfLinear_State& _state, int32_t value) noexcept
    {
        _SvfLinear__tap (_state._state, value);
    }

    void _SvfLinear__tap (_SvfLinear_State& _state, int32_t v) noexcept
    {
        _state.tapSel = v;
    }

    void _initialise (SvfLinear_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
    {
        _SvfLinear___initialise (_state._state, processorID, sessionID, frequency);
    }

    void _SvfLinear___initialise (_SvfLinear_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
    {
    ...
    void _advance (SvfLinear_State& _state, SvfLinear_IO& _io, int32_t _frames) noexcept
    {
        _SvfLinear_IO  ioCopy;
        ...
        for (;;)
        {
            ...
            ioCopy = _SvfLinear_IO {};
            ioCopy.in = _io.in[_state._currentFrame];
            _SvfLinear__main (_state._state, ioCopy);
    ...
    void _SvfLinear__main (_SvfLinear_State& _state, _SvfLinear_IO& _io) noexcept
    {
        float  v0;
        float  v3;
        float  v1;
    ...
    void _SvfLinear__recompute (_SvfLinear_State& _state) noexcept
    {
        float  sr;
        float  c;
        float  r;
